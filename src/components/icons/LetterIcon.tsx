export const LetterIcon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        <g stroke="#000" strokeWidth={1.5}>
            <path d="M18 6.102c1.3.127 2.175.416 2.828 1.07C22 8.343 22 10.229 22 14c0 3.771 0 5.657-1.172 6.828C19.657 22 17.771 22 14 22h-4c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14c0-3.771 0-5.657 1.172-6.828C3.825 6.518 4.7 6.229 6 6.102" />
            <path
                strokeLinecap="round"
